...
$sql = "SELECT * FROM puertas_valores_elementos WHERE k_codusuario=".$codigo_inspector." AND k_codinspeccion=".$codigo_inspeccion." ORDER BY k_coditem";
...
while($row = mysqli_fetch_array($result)){ 
    ...
    $puertas_valores_elementos[] = array('v_seleccion'=> $v_seleccion);
}
