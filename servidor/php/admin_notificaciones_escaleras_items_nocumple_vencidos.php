  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <br>
        <center>
          <h4><span><b>INFORME - INSPECCIONES ESCALERAS - SEGUNDA REVISIÓN - PLAZO VENCIDO</b></span></h4>
        </center>
        <br>
        <div class="div_division sombra"></div>
        <br>             
