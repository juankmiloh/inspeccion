...
$sql = "SELECT * FROM ascensor_valores_foso WHERE k_codusuario=".$codigo_inspector." AND k_codinspeccion=".$codigo_inspeccion." ORDER BY k_coditem";
...
while($row = mysqli_fetch_array($result)){ 
    ...
    $ascensor_valores_foso[] = array('v_calificacion'=> $v_calificacion,
