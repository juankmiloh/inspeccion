...
<head>
    ...
    <script type="text/javascript" src="../javascript/script_puertas_registrofotografico.js"/></script>
...
<?php
    ...
    *==============================================*/
    $sql = "SELECT * FROM puertas_valores_iniciales WHERE k_codusuario = ".$_GET['id_inspector']." AND 
...
<?
    ...
    *==============================================*/
    $sql = "SELECT * FROM puertas_valores_fotografias WHERE k_codusuario = ".$_GET['id_inspector']." AND 
...
?>  
            <div class="col-xs-4 col-md-4" style="text-align: center;">
                <img id="<?php echo $row['n_fotografia']; ?>" onclick="mostrarDetalleFoto(this.id)" class="img-thumbnail sombra" data-toggle="modal" data-target="#gridSystemModal" style="cursor: pointer; max-width: 100%; height: auto;" src="../puertas/inspector_<?php echo $_GET['id_inspector']; ?>/fotografias/<?php echo $_GET['cod_inspeccion']; ?>/<?php echo $row['n_fotografia']; ?>"><br><br>
