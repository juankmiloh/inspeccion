<?php
  ...
  $notificacion_escaleras = array(); //creamos un array
  ...
  * SI LA CANTIDAD DE DIAS ESTA ENTRE 15 Y 30 SE AÑADE AL ARREGLO
	*==============================================*/
  $sql="SELECT *,DATEDIFF(now(),f_carga_servidor) AS cantidad_dias FROM auditoria_inspecciones_escaleras WHERE v_item_leve>9 OR v_item_grave>0 OR v_item_muygrave>0 AND f_carga_servidor<>'0000-00-00 00:00:00' ORDER BY cantidad_dias";
  $result=mysqli_query($con, $sql);
  $cantidad_inspecciones_graves=0;
  $notificacion_escaleras_graves = array(); //creamos un array
  ...
  $notificacion_escaleras[] = array('id'=> 'escaleras_cantidad_inspecciones_graves',
  ...
  *==============================================*/
  $sql="SELECT *,DATEDIFF(now(),f_carga_servidor) AS cantidad_dias FROM auditoria_inspecciones_escaleras WHERE v_item_leve>0 AND v_item_leve<10 AND v_item_grave=0 AND v_item_muygrave=0 AND f_carga_servidor<>'0000-00-00 00:00:00' ORDER BY cantidad_dias";
  $result=mysqli_query($con, $sql);
  ...
  $notificacion_escaleras[] = array('id'=> 'escaleras_cantidad_inspecciones_leves',
  ...
  *==============================================*/
  ...
  $notificacion_escaleras[] = array('id'=> 'escaleras_cantidad_inspecciones_vencidas',
  ...
  *==============================================*/
  $sql="SELECT *,DATEDIFF(now(),f_carga_servidor) AS cantidad_dias FROM auditoria_inspecciones_escaleras WHERE v_item_nocumple=0 AND f_carga_servidor<>'0000-00-00 00:00:00' ORDER BY cantidad_dias";
  $result=mysqli_query($con, $sql);
  ...
  $notificacion_escaleras[] = array('id'=> 'escaleras_cantidad_certificados_x_vencer',
  ...
  *==============================================*/
  ...
  $notificacion_escaleras[] = array('id'=> 'escaleras_cantidad_certificados_vencidos',
	...
	//Creamos el JSON
	$json_string = json_encode($notificacion_escaleras);
	echo $json_string;
?>