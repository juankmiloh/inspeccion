<?php
  ...
  * SI LA CANTIDAD DE DIAS ESTA ENTRE 15 Y 30 SE AÑADE AL ARREGLO
  ...
  $notificacion_ascensores_graves = array(); //creamos un array
  ...
  $notificacion_ascensores[] = array('id'=> 'ascensor_cantidad_inspecciones_graves',
  ...
  *==============================================*/
  ...
  $notificacion_ascensores[] = array('id'=> 'ascensor_cantidad_inspecciones_leves',
  ...
  *==============================================*/
  ...
  $cantidad_inspecciones_vencidas = ($cantidad_inspecciones_graves_vencidas + $cantidad_inspecciones_leves_vencidas) - 86;

  $notificacion_ascensores[] = array('id'=> 'ascensor_cantidad_inspecciones_vencidas',
