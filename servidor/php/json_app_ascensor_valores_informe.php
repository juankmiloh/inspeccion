...
$sql = "SELECT * from informe i,auditoria_inspecciones_ascensores a WHERE a.k_codusuario=".$codigo_inspector." AND i.k_codusuario=a.k_codusuario AND i.k_codinforme=a.k_codinforme AND a.o_actualizar_inspeccion='Si' ORDER BY i.f_informe DESC LIMIT 1";
