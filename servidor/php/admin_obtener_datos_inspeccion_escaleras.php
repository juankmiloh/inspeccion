<?php
	...
	*==============================================*/
    $sql="SELECT informe_audios.n_audio nombre_audio FROM informe_valores_audios informe_audios,auditoria_inspecciones_escaleras auditoria WHERE auditoria.k_codusuario_modifica=".$k_codusuario_modifica." AND auditoria.k_codinspeccion=".$codigo_inspeccion." AND informe_audios.k_codusuario=".$k_codusuario_modifica." AND auditoria.k_codinforme=informe_audios.k_codinforme AND informe_audios.k_codinforme=".$k_codinforme."";
	...
	*==============================================*/
	$sql="SELECT * FROM escaleras_valores_fotografias WHERE k_codusuario=".$codigo_inspector." AND k_codinspeccion=".$codigo_inspeccion."";
    $result=mysqli_query($con, $sql);
	...
	*==============================================*/
	...
	$auditoria_inspecciones_escaleras = array(); //creamos un array
	...
	//Creamos el JSON
	$json_string = json_encode($auditoria_inspecciones_escaleras);
	echo $json_string;
?>