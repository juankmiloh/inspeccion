...
<?php
 ...
 //    // linea para mover la foto recibida desde el dispositivo a la carpeta del servidor
	// move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], "/Applications/MAMP/htdocs/inspeccion/servidor/ascensores/inspector_".$codigo_inspector_1."/fotografias/".$codigo_inspeccion."/".$nombre_archivo);
?>
