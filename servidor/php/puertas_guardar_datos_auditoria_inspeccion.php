<?php
  ...
  $json_auditoria_puertas = $_POST['json_auditoria_puertas'];
  ...
  *==============================================*/     
  ...
  $array = json_decode($json_auditoria_puertas);
  ...
  foreach($array as $obj){
    ...
    if($rowcount >= 1){
      ...
      $sql="INSERT INTO auditoria_inspecciones_puertas(
                            k_codusuario,
                            k_codinspeccion, 
                            o_consecutivoinsp,
                            o_estado_envio,
