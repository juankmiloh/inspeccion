<?php
  ...
  $json_auditoria_escaleras = $_POST['json_auditoria_escaleras'];
  ...
  *==============================================*/     
  ...
  $array = json_decode($json_auditoria_escaleras);
  ...
  foreach($array as $obj){
    ...
    if($rowcount >= 1){
      ...
      $sql="INSERT INTO auditoria_inspecciones_escaleras(
                            k_codusuario,
                            k_codinspeccion, 
                            o_consecutivoinsp,
                            o_estado_envio,
