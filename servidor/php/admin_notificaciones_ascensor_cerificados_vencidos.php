  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <br>
        <center>
          <h4><span><b>INFORME - INSPECCIONES ASCENSORES - CERTIFICADOS VENCIDOS</b></span></h4>
        </center>
        <br>
        <div class="div_division sombra"></div>
        <br>             
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12" style="border: 0px solid red;">
        <div id="div_notificacion_ascensores">
                ...
                ?>
                      <tr>
                        ...
                        <td class="centrar_texto" style="padding: 15px;">
                          <?php
                            echo '
                            <a href="../php/ascensor_modificar_lista_inspeccion.php?id_inspector='.$k_codusuario.'&cod_inspeccion='.$k_codinspeccion.'" target="_blank">
