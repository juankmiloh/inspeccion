<?php
    ...
    $sql = "SELECT * FROM auditoria_inspecciones_puertas WHERE k_codusuario=".$codigo_inspector." ORDER BY o_consecutivoinsp desc";
    ...
    while($row = mysqli_fetch_array($result)){ 
        ...
        *==============================================*/
        $sql_cliente="SELECT * FROM puertas_valores_iniciales WHERE k_codinspeccion=".$k_codinspeccion." AND k_codusuario=".$codigo_inspector."";
