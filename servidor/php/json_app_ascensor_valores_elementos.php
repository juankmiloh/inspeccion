...
$sql = "SELECT * from ascensor_valores_elementos v,auditoria_inspecciones_ascensores a WHERE v.k_codusuario=".$codigo_inspector." AND v.k_codusuario=a.k_codusuario AND v.k_codinspeccion=a.k_codinspeccion AND a.o_actualizar_inspeccion='Si'";
...
while($row = mysqli_fetch_array($result)){ 
    ...
    $ascensor_valores_elementos[] = array('k_codusuario'=> $k_codusuario,
