...
$directory="../../puertas/servidor/inspector_".$codigo_inspector_url."/registros_pdf"; // directorio de donde se encuentran los archivos en el servidor
...
while (($archivo = $dirint->read()) !== false)
{
    if ($archivo != "." and $archivo != ".DS_Store" and $archivo != ".txt") {
        if ($archivo != "..") {
            //echo $archivo;
            $smtp->AddAttachment("../../puertas/servidor/inspector_".$codigo_inspector_url."/registros_pdf/".$archivo, $archivo);
        }
    }
}
...
if($bandera == 0){
    ...
    while (($archivo = $dirint->read()) !== false)
    {
        if ($archivo != "." and $archivo != ".DS_Store" and $archivo != ".txt") {
            if ($archivo != "..") {
                //echo $archivo;
                unlink("../../puertas/servidor/inspector_".$codigo_inspector_url."/registros_pdf/".$archivo);
                $bandera=0;
            }
        }
    }
