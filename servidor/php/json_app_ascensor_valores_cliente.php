...
$sql = "SELECT * from cliente c,auditoria_inspecciones_ascensores a WHERE a.k_codusuario=".$codigo_inspector." AND c.k_codusuario=a.k_codusuario AND c.k_codcliente=a.k_codcliente AND a.o_actualizar_inspeccion='Si' ORDER BY c.consecutivo DESC LIMIT 1";
