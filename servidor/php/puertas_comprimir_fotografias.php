<?php
    ...
    unlink("./inspeccion_puertas_".$codigo_inspector."_".$codigo_inspeccion.".zip");

    $carpeta = dirname("../puertas/inspector_".$codigo_inspector."/fotografias/".$codigo_inspeccion."/*"); /*Línea de código para el localhost de producción*/
    $archivo_final = 'inspeccion_puertas_'.$codigo_inspector.'_'.$codigo_inspeccion.'.zip';  // .zip *

    comprimir($carpeta, $archivo_final, false, false);
    //header("Location: ./inspeccion_".$codigo_inspector."_".$codigo_inspeccion.".zip");
    //header("Location: ./puertas_descargar_fotografias.php?codigo_inspector=4&codigo_inspeccion=5");
