...
$sql = "SELECT * FROM escaleras_valores_finales WHERE k_codusuario=".$codigo_inspector." AND k_codinspeccion=".$codigo_inspeccion."";
...
while($row = mysqli_fetch_array($result)){
    ...
    $escaleras_valores_finales[] = array('o_observacion'=> $o_observacion);
}
