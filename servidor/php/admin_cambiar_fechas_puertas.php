<?php
  ...
  *==============================================*/
  $contador = 0;
  $sql="SELECT * FROM auditoria_inspecciones_puertas WHERE f_carga_servidor='0000-00-00 00:00:00' AND k_codusuario<>3 ORDER BY k_codusuario";
  ...
  while($row = mysqli_fetch_array($result)){
    ...
    while($row1 = mysqli_fetch_array($result1)){
      ...
      echo "k_codusuario ".$k_codusuario." k_codinspeccion ".$k_codinspeccion."<br>";
      $notificacion_puertas[] = array('k_codusuario'=> $k_codusuario,
                                         'k_codinspeccion'=> $k_codinspeccion,
                                         'f_fecha'=> $f_fecha);
      $sql2="UPDATE auditoria_inspecciones_puertas SET f_carga_servidor='".$f_fecha."' WHERE k_codusuario=".$k_codusuario." AND k_codinspeccion=".$k_codinspeccion."";
