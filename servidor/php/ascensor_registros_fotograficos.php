...
<head>
    ...
    <script type="text/javascript" src="../javascript/script_ascensor_registro_fotografico.js"/></script>
...
<?php
    ...
    *==============================================*/
    $sql = "SELECT * FROM ascensor_valores_iniciales WHERE k_codusuario = ".$_GET['id_inspector']." AND 
...
<?
    ...
    *==============================================*/
    $sql = "SELECT * FROM ascensor_valores_fotografias WHERE k_codusuario = ".$_GET['id_inspector']." AND 
                                                             k_codinspeccion=".$_GET['cod_inspeccion']." AND
                                                             k_coditem=".$_GET['cod_item'];
    $result = mysqli_query($con, $sql);
    while ($row = mysqli_fetch_array($result)) {
?>  
            <div class="col-xs-4 col-md-4" style="text-align: center;">
                <img id="<?php echo $row['n_fotografia']; ?>" onclick="mostrarDetalleFoto(this.id)" class="img-thumbnail sombra" data-toggle="modal" data-target="#gridSystemModal" style="cursor: pointer; max-width: 100%; height: auto;" src="../ascensores/inspector_<?php echo $_GET['id_inspector']; ?>/fotografias/<?php echo $_GET['cod_inspeccion']; ?>/<?php echo $row['n_fotografia']; ?>"><br><br>
