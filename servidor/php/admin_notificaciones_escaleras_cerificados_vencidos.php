  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <br>
        <center>
          <h4><span><b>INFORME - INSPECCIONES ESCALERAS - CERTIFICADOS VENCIDOS</b></span></h4>
        </center>
        <br>
        <div class="div_division sombra"></div>
        <br>             
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12" style="border: 0px solid red;">
        <div id="div_notificacion_escaleras">
            ...
            <table class="table table-hover table-bordered" id="tabla_escaleras">
              <thead>
                ...
                <tr>
                  ...
                  <th class="active centrar_texto">
                    <center><b>DÍAS VENCIDOS</b></center>
                  </th>
                  <th class="active centrar_texto">
              ...
              <tbody>
                <?php
                  ...
                  *==============================================*/
                  $sql="SELECT *,DATE_FORMAT(f_carga_servidor,'%d-%m-%Y') AS f_carga,DATE_FORMAT(ADDDATE(f_carga_servidor, INTERVAL 365 DAY),'%d-%m-%Y') AS f_vencimiento,DATEDIFF(now(),f_carga_servidor) AS cantidad_dias, DATEDIFF(now(),f_carga_servidor) - 365 as dias_vencidos FROM auditoria_inspecciones_escaleras WHERE v_item_nocumple=0 AND f_carga_servidor<>'0000-00-00 00:00:00' AND DATEDIFF(now(),f_carga_servidor) >= 365 ORDER BY cantidad_dias DESC";
                  ...
                  while($row = mysqli_fetch_array($result)){
                    ...
                    *==============================================*/
                    $sql1="SELECT * FROM escaleras_valores_iniciales WHERE k_codusuario=".$k_codusuario." AND k_codinspeccion=".$k_codinspeccion."";
                ...
                ?>
                      <tr>
                        ...
                        <td class="centrar_texto" style="padding: 15px;">
                          <?php
                            echo '
                            <a href="../php/escaleras_modificar_lista_inspeccion.php?id_inspector='.$k_codusuario.'&cod_inspeccion='.$k_codinspeccion.'" target="_blank">
