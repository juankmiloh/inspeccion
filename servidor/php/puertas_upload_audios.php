<?php
    ...
    $file_to_save = "../puertas/inspector_".$codigo_inspector_1."/audios/".$codigo_inspeccion."/".$nombre_archivo;
...
<?php
 ...
 //   	mkdir(dirname($file_to_save), 0777, true); //esta linea es para crear el directorio si no existe
	...
	// move_uploaded_file($_FILES["file"]["tmp_name"], "/Applications/MAMP/htdocs/inspeccion/servidor/puertas/inspector_".$codigo_inspector_1."/audios/".$codigo_inspeccion."/".$nombre_archivo);
?>
...
<?php
    ...
    // move_uploaded_file($_FILES["file"]["tmp_name"], "/home/montajesyproceso/public_html/inspeccion/servidor/puertas/inspector_".$codigo_inspector_1."/audios/".$codigo_inspeccion."/".$nombre_archivo);
?>