...
$sql = "SELECT * FROM escaleras_valores_proteccion WHERE k_codusuario=".$codigo_inspector." AND k_codinspeccion=".$codigo_inspeccion." ORDER BY k_coditem";
...
while($row = mysqli_fetch_array($result)){ 
    ...
    $escaleras_valores_proteccion[] = array('v_sele_inspector'=> $v_sele_inspector,
