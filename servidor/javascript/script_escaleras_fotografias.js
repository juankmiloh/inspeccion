  ...
  $.ajax({
    ...
    success: function(response){
      ...
      if (response == 0) {
        ...
        location.href="escaleras_fotografias_inspeccion.php?id_inspector="+codigo_inspector+"&cod_inspeccion="+codigo_inspeccion+"";
      }else{
...
function crearPDF(){
  ...
  $.post('escaleras_crear_pdf_inspeccion.php',{
    ...
    if (e == 0) {
      ...
      myWindow = window.open('http://www.montajesyprocesos.com/inspeccion/servidor/escaleras/servidor/inspector_'
                  +codigo_inspector
                  +'/registros_pdf/'
...
function descargar_fotos(argument) {
  var codigo_inspector = getQueryVariable('id_inspector');
  var codigo_inspeccion = getQueryVariable('cod_inspeccion');
  $.post('escaleras_comprimir_fotografias.php',{
    codigo_inspector: codigo_inspector,
    codigo_inspeccion: codigo_inspeccion
  },function(e){
    location.href="../php/inspeccion_escaleras_"+codigo_inspector+"_"+codigo_inspeccion+".zip";
  });
}
