...
function guardarInspeccion(){
  ...
  * ============================= */
  ...
  updateItemsAuditoriaInspeccionesEscaleras(cod_usuario,codigo_inspeccion,consecutivo_inspeccion,contador_items_nocumple,'Si');
}
...
*==============================================*/
function updateItemsAuditoriaInspeccionesEscaleras(cod_inspector,cod_inspeccion,consecutivo_insp,cantidad_nocumple,o_actualizar_inspeccion) {
  var estado_revision;
