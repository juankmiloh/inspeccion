jQuery(document).ready(function($){
  ...
  // actualizar_contadores_items();
});

// var contador_inspeccion = 19;
// /*=============================================
// * Funcion que permite crear en el servidor el PDF de la inspeccion
// *==============================================*/
// function actualizar_contadores_items(){
//   location.href = "#arriba";
//   abrir_Ventana_Carga();
//   var codigo_inspector = 2;
//   var codigo_inspeccion = contador_inspeccion;
//   var consecutivo_inspeccion = $("#text_consecutivo").val();
//   $('#texto_carga').text('Creando PDF inspector '+codigo_inspector+' ...Espere inspeccion # '+contador_inspeccion);
...
//       if (contador_inspeccion < 131) {
//         contador_inspeccion += 1;
//         setTimeout(actualizar_contadores_items, 1000);
//       }
...
function crearPDF(){
  ...
  $.post('ascensor_crear_pdf_inspeccion.php',{
    ...
    //alert("crearPDF-> "+e);
    //location.href="http://192.168.0.30:8888/inspeccion/servidor/php/ascensor_crear_pdf_inspeccion.php";
    if (e == 0) {
      $('#texto_carga').text('PDF de inspección Saved...OK');
