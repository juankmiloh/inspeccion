...
function mostrarDetalleFoto(nombre_foto){
    ...
    largeImage.src="../puertas/inspector_"+codigo_inspector+"/fotografias/"+codigo_inspeccion+"/"+nombre_foto+"";
  ...
  $.ajax({
    ...
    success: function(response){
      ...
      if (response == 0) {
        ...
        location.href="puertas_fotografias_inspeccion.php?id_inspector="+codigo_inspector+"&cod_inspeccion="+codigo_inspeccion+"";
      }else{
...
function crearPDF(){
  ...
  $.post('puertas_crear_pdf_inspeccion.php',{
    ...
    if (e == 0) {
      ...
      myWindow = window.open('http://www.montajesyprocesos.com/inspeccion/servidor/puertas/servidor/inspector_'
                  +codigo_inspector
                  +'/registros_pdf/'
...
function enviar_email(text_correo){
  ...
  $.post('../php/email/puertas_servidor_enviar_correo.php',{
    codigo_inspector: codigo_inspector,
...
function descargar_fotos(argument) {
  var codigo_inspector = getQueryVariable('id_inspector');
  var codigo_inspeccion = getQueryVariable('cod_inspeccion');
  $.post('puertas_comprimir_fotografias.php',{
    codigo_inspector: codigo_inspector,
    codigo_inspeccion: codigo_inspeccion
  },function(e){
    location.href="../php/inspeccion_puertas_"+codigo_inspector+"_"+codigo_inspeccion+".zip";
  });
}
